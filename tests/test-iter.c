...
static void
test_bson_iter_decimal128 (void) {
   ...
   _Decimal128 v2 = bson_iter_decimal128(&iter);
   assert(v2 == value);
...
test_iter_install (TestSuite *suite)
{
   ...
   TestSuite_AddFull (suite, "/bson/iter/test_decimal128", test_bson_iter_decimal128, should_run_decimal_test);
   ...
   TestSuite_AddFull (suite, "/bson/iter/test_bson_iter_overwrite_decimal128", test_bson_iter_overwrite_decimal128, should_run_decimal_test);
